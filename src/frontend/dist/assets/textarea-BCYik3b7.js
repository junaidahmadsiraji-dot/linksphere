import { j as jsxRuntimeExports, i as cn, r as reactExports, R as React, J as reactDomExports, K as ReactDOM } from "./index-DpisiOh5.js";
import { X } from "./x-TmiiBXt_.js";
const variants = {
  primary: "gradient-primary text-primary-foreground shadow-md hover:shadow-elevated hover:brightness-110",
...
function GradientButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      ...props,
      children: [
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 rounded-full border-2 border-current/30 border-t-current animate-spin" }),
        children
      ]
    }
  );
